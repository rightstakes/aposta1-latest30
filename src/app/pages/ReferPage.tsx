        ...
        <div className="bg-gradient-to-r from-[#1a1147] via-[#2d1569] to-[#1a1147] border-b border-white/15">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
            <div className="flex items-center gap-3 mb-2">
              <div className="w-10 h-10 rounded-xl flex items-center justify-center bg-[#00C44D22]">
                <Users className="w-5 h-5 text-[#00C44D]" />
              </div>
              <div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 space-y-5">
          ...
          <div className={card}>
            <div className={sectionHeader}>
              <Share2 className="w-4 h-4 text-[#00C44D]" />
          ...
          <div className={`${card} overflow-hidden`}>
            <div className={sectionHeader}>
              <Users className="w-4 h-4 text-[#00C44D]" />
              <h3 className="text-white font-semibold text-sm">Seus Indicados</h3>
              <span className="ml-auto text-xs font-bold px-2 py-0.5 rounded-full bg-[#00C44D22] text-[#00C44D]">
                {totalReferred}
              </span>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
            ...
            <div className={`${card} overflow-hidden`}>
              <div className={sectionHeader}>
                <Gift className="w-4 h-4 text-[#00C44D]" />
                  ...
                  <div key={i} className="flex items-start gap-3">
                    ...
                    <div>
                      <div className="flex items-center gap-2 mb-0.5">
                        <span className="text-[10px] font-bold px-1.5 py-0.5 rounded text-white bg-[#00C44D]">{i + 1}</span>
            ...
            <div className={`${card} overflow-hidden`}>
              ...
              <div className="p-5 space-y-3">
                ...
                <button className="mt-2 text-xs font-semibold flex items-center gap-1 hover:gap-2 transition-all pt-1 text-[#00C44D]">
